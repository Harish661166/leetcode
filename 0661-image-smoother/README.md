<h2><a href="https://leetcode.com/problems/maximum-width-of-binary-tree/solutions/4423391/video-give-me-10-minutes-how-we-think-ab-y3wd/?envType=problem-list-v2&envId=db76da2i">661. Image Smoother</a></h2><h3>Easy</h3><hr><p>An <strong>image smoother</strong> is a filter of the size <code>3 x 3</code> that can be applied to each cell of an image by rounding down the average of the cell and the eight surrounding cells (i.e., the average of the nine cells in the blue smoother). If one or more of the surrounding cells of a cell is not present, we do not consider it in the average (i.e., the average of the four cells in the red smoother).</p>
