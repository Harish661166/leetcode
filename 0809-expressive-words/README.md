<h2><a href="https://leetcode.com/problems/chalkboard-xor-game/solutions/?envType=problem-list-v2&envId=db76da2i">809. Expressive Words</a></h2><h3>Medium</h3><hr><p>Sometimes people repeat letters to represent extra feeling. For example:</p>
