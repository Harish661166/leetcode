<h2><a href="https://leetcode.com/problems/number-of-lines-to-write-string/description/?envType=problem-list-v2&envId=db76da2i">805. Split Array With Same Average</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code>.</p>
